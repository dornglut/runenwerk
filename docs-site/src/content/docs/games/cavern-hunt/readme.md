---
title: "Game Folder"
description: "Documentation for Game Folder."
---
...
- Start from [CAVERN_HUNT_GDD.md](/Users/joshua/Projekte/multiplayer_workspace/grotto-quest/games/cavern_hunt/docs/CAVERN_HUNT_GDD.md) for the current primary game concept.
- Use [CAVERN_HUNT_MATERIALS.md](/Users/joshua/Projekte/multiplayer_workspace/grotto-quest/games/cavern_hunt/docs/CAVERN_HUNT_MATERIALS.md) for the material graph, PBR-lite, and GI rollout details.
- Use [CAVERN_HUNT_PLAYTEST.md](/Users/joshua/Projekte/multiplayer_workspace/grotto-quest/games/cavern_hunt/docs/CAVERN_HUNT_PLAYTEST.md) for launch/test flow and troubleshooting.
