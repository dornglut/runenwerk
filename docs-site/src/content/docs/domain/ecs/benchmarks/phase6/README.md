---
title: ECS Phase 6 Closeout Moved
description: Compatibility index for moved ECS Phase 6 closeout reports.
status: superseded
owner: ecs
layer: domain
canonical: false
last_reviewed: 2026-04-27
replaced_by: ../../../reports/closeouts/ecs-phase6/
---

# ECS Phase 6 Closeout Moved
