...
- Deferred beyond M3.6 and its 2026-05-08 maturity pass: payload ECS enum variants, native OS menu/shortcut integration, asset/procedural/gameplay/runtime overlay authoring, external marketplace workflows, compiled-reactive UI execution, and ECS-driven UI execution.
