---
title: "SceneManager UI Example (Template-Driven)"
description: "Documentation for SceneManager UI Example (Template-Driven)."
---
...
This example should follow the shared engine scene authoring model described in [scene plugin usage](../../reference/plugins/scene/usage-guide.md).
