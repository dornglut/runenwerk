...
description: Normalized input and gesture vocabulary for reusable controls, surface packages, and future device support.
status: active
owner: ui
layer: domain
canonical: true
...
Generic interaction must support pointer, wheel, keyboard, semantic actions, text input, touch readiness, controller/semantic parity, and stylus/tablet facts without moving device packet ownership into controls.

## Feature List

- pointer, wheel, keyboard, semantic action, and text input
- touch-ready vocabulary
- controller/semantic action parity
- hover/contact/pressure/tilt/twist/tangential pressure
- eraser and barrel button facts
- coalesced and predicted samples
- pointer capture and lost capture
- drag, marquee/select rectangle, multi-click
- cancel, commit, rollback

## Ergonomics Gate

Control authors declare supported input modes and gestures without implementing packet normalization.
