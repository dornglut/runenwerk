...
description: Defines how component/control evidence is recorded through UiStoryRunReport without moving behavior ownership into ui_story.
status: active
owner: ui
layer: domain
canonical: true
...
Control maturity is accepted only through story evidence. UI Story owns the proof envelope, not component behavior, runtime dispatch, text shaping, surface behavior, or product mutation.

## Feature List

- control package evidence
...
- human-readable and machine-readable report projections

## Ergonomics Gate

Every failing component story explains what failed, which control/state/binding/route/token/source was involved, and what the author should fix.

## Out Of Scope

- UI Story executing app behavior
- UI Story owning controls
- UI Story owning renderer resources
