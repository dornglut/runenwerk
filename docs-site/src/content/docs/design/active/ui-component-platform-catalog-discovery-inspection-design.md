...
description: Reusable catalog and inspection contract for Gallery, UI Designer, Workbench, docs, and agents.
status: active
owner: ui
layer: domain
canonical: true
...
Controls and surface packages must be discoverable, filterable, inspectable, and copyable through one shared catalog contract.

## Feature List

- search
- category/tag/target-profile/capability/state filters
- accessibility and story-status filters
- expected-failure filter
- preview metadata
- required token and binding display
- supported state and interaction display
- compatibility explanation
- source-map links
- diagnostic badges
- copy package/story/route/fixture ids

## Ergonomics Gate

Gallery and UI Designer show a useful catalog rather than raw package ids or hardcoded fixture names.

## Out Of Scope

- Gallery-owned control behavior
- Designer-owned reusable control semantics
- hidden package registries
