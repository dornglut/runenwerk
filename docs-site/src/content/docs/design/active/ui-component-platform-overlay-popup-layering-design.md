---
title: UI Component Platform Overlay Popup And Layering Design
description: Reusable overlay, portal, popup, menu, tooltip, z-order, focus, and dismissal contract.
status: active
owner: ui
layer: domain
canonical: true
...
# UI Component Platform Overlay Popup And Layering Design
...
Popup/menu/tooltip/overlay behavior is reusable platform behavior, not local menu polish.

## Feature List

- portal root and overlay root
- popup, tooltip, context menu, menu, submenu, picker popup, combobox popup
- modal and sheet readiness
- z-order policy
- anchor placement and collision/clamping
- outside dismiss and Escape dismiss
- focus return
- scroll containment
- pointer capture
- diagnostic overlay
...
Popup failures explain anchor, placement, clipping, z-order, focus, and dismissal facts.
