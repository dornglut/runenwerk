...
| WR-146 | 6F Headless Fixture Diagnostics Source Map Proof | Product planning | current_candidate | not_applicable | L4 | Implementation plan accepted | 4 | 2 | 2 | 2 | 2 | 5 | 0.5 | 1.0 | N/A | Basic | PM-UI-PROGRAM-012 accepted implementation plan exists at docs-site/src/content/docs/reports/implementation-plans/wr-146-6f-headless-fixture-diagnostics-source-map-proof/plan.md; product_code has not run. | Manifest Runner V2 agent_design created the accepted Stage 6F implementation plan. This authorizes only the next V5 product_implementation gate when explicitly allowed. |
