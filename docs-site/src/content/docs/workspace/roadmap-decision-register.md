...
| WR-089 | Renderer Procedural Population Hardening Doctrine And Track Activation | Render planning | current_candidate | not_applicable | L4 | Doctrine activation before hardening implementation | 4 | 2 | 3 | 4 | 3 | 2 | 0.8 | 5.6 | N/A | Performance | Complete doctrine and track activation with active hardening design, production track metadata, WR-090 through WR-093 implementation contracts, and a bounded-contract closeout for WR-089. | Intake accepted as a doctrine-first hardening track. WR-089 must not absorb indirect draw, primitive dispatch, graph catch-up, or unbounded population implementation. |
...
| WR-092 | Fixed Step Graph Catch Up Scheduling | Render hardening | ready_next | not_applicable | L4 | After primitive shader dispatch | 4 | 2 | 4 | 4 | 4 | 5 | 0.8 | 2.6 | N/A | Performance | Promote only after WR-091 closes. Implementation must prove graph-level bounded repeated pass execution, deterministic submitted substeps, and resource sequencing across substeps. | Ready-next graph scheduling slice after primitive dispatch is runtime-proven. |
| WR-093 | Procedural Population Hardening Evidence Benchmarks Docs And Closeout | Render evidence | ready_next | not_applicable | L4 | After graph catch-up scheduling | 4 | 2 | 3 | 4 | 3 | 3 | 0.8 | 3.7 | N/A | Performance | Promote only after WR-092 closes. Close the hardening track only when runtime evidence proves indirect validation, primitive shader dispatch, graph catch-up scheduling, benchmarks, and docs. | Ready-next evidence and closeout slice for PT-RENDER-PROCEDURAL-POPULATION-HARDENING. |
