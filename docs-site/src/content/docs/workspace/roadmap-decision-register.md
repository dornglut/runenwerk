...
| WR-019 | Field Visualizer product workflow | Product workflow | current_candidate | L2 | After rendered-world V1 | 4 | 2 | 3 | 4 | 4 | 5 | 0.8 | 2.4 | Product debug workflow after viewport packet stability | Performance | docs-site/src/content/docs/reports/implementation-plans/wr-019-field-visualizer-product-workflow/plan.md; readiness: contract states WR-019 can carry a bounded implementation contract after WR-018 completion, PM-SDF-OW-001 active link, and active Field Visualizer design evidence | docs-site/src/content/docs/reports/implementation-plans/wr-019-field-visualizer-product-workflow/plan.md; readiness: contract states WR-019 can carry a bounded implementation contract after WR-018 completion, PM-SDF-OW-001 active link, and active Field Visualizer design evidence |
...
| WR-021 | Material Lab and material preview products | Product workflow | ready_next | L3 | After rendered-world V1 and Field Visualizer | 4 | 2 | 3 | 4 | 4 | 8 | 0.5 | 0.9 | Material authoring after render/product handoff stabilizes | Performance | Source-backed MaterialGraphDocument, lowering/ratification, preview product, diagnostics, and render handoff. | Promote Material Lab now as the FR-4 material preview/product handoff track, but implement it after multi-entity viewport and field visualization stabilize. |
