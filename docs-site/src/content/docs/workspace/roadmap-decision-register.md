...
| WR-008 | Native tablet input backend arbitration and diagnostics | Product discovery | ready_next | not_applicable | L1 | Product evidence gate | 3 | 2 | 2 | 3 | 2 | 5 | 0.5 | 1.0 | Candidate after hardware target exists | Basic | Hardware validation across Windows Ink, Wacom Wintab, and macOS Wacom. | WR-006 dependency is complete; code can continue, but product acceptance is hardware-blocked. |
...
| WR-089 | UI Lab perfectionist governance and no-gap audit doctrine | Product planning | current_candidate | not_applicable | L4 | Current-candidate governance contract | 3 | 3 | 2 | 3 | 2 | 5 | 0.5 | 1.0 | N/A | Basic | Complete PM-UI-LAB-PERF-001 with accepted audit doctrine, code-truth matrix, evidence matrix, hard blockers, and disjoint follow-on WR candidates. | WR-089 is the current governance/design candidate for PT-UI-LAB-PERFECTION; it may update planning docs and audit doctrine only. |
