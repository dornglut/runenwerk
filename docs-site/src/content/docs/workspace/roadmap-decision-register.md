...
| WR-020 | Source-backed Asset Core Contracts | Core support | ready_next | L1 | Supporting now | 5 | 3 | 4 | 5 | 5 | 8 | 0.8 | 1.9 | Stable asset identity before material and prefab implementation | Basic | Domain-owned project catalog descriptors, deterministic import plans, dependency graph contracts, diagnostics, ratification, and prior-valid artifact preservation. | Stabilize source descriptors for SDF graph, field product, material graph/material, UI definition, and prefab descriptors in domain/asset before broad external import work or editor adapter expansion. |
| WR-026 | Source-backed Asset Editor Adapters | Core support | ready_next | L2 | After asset core contracts | 4 | 3 | 3 | 4 | 4 | 5 | 0.8 | 2.4 | Editor catalog workflow after domain asset identity stabilizes | Basic | App-owned project catalog load/save, deterministic import job orchestration, diagnostics surfacing, and prior-valid artifact preservation through domain/asset contracts. | Keep editor asset pipeline code as adapter/workflow wiring over domain/asset contracts, not the source of semantic asset truth. |
