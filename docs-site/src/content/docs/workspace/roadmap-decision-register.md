...
| WR-089 | Renderer Procedural Population Hardening Doctrine And Track Activation | Render planning | current_candidate | not_applicable | L4 | Doctrine activation before hardening implementation | 4 | 2 | 3 | 4 | 3 | 2 | 0.8 | 5.6 | N/A | Performance | Complete doctrine and track activation with active hardening design, production track metadata, WR-090, WR-091, WR-092, WR-101 implementation contracts, WR-093 closeout contract, the separate behavior-authoring intake, and a bounded-contract closeout for WR-089. | Intake accepted as a doctrine-first hardening track. WR-089 must not absorb indirect draw, primitive dispatch, graph catch-up, procedural camera, behavior-authoring, or unbounded population implementation. |
