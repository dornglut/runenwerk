...
| WR-181 | UI Composition Core Contracts And Invariants | UI architecture | current_candidate | not_applicable | L4 | Region Compass selected and checkpoint 1 closed | 5 | 2 | 5 | 5 | 5 | 8 | 0.8 | 2.0 | N/A | Must-be | PM-UI-COMPOSITION-001 closed with selected Region Compass evidence; WR-181 decision-complete plan.contract.yaml accepted on 2026-06-19 | PM-UI-COMPOSITION-001 closed with selected Region Compass evidence; WR-181 decision-complete plan.contract.yaml accepted on 2026-06-19 |
