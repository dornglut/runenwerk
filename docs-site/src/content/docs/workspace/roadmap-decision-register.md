...
| WR-007 | Multiplayer replication Phase 1 to Phase 3 | Core delivery | completed | L1 | Completed | 4 | 2 | 2 | 4 | 4 | 8 | 0.8 | 1.4 | N/A | Neutral | 2026-05-15 Phase 1-3 landed ACK/baseline hardening, delta lifecycle normalization, and engine bridge baseline convergence with focused engine_net and engine plugin tests. | Phase 1-3 is complete; future replication work should build on the accepted ACK/baseline outcome contract and engine bridge checkpoint behavior instead of reopening ad hoc baseline mutation. |
...
| WR-018 | Rendered World V1 | Core delivery | current_candidate | L1 | Current candidate | 5 | 2 | 4 | 5 | 5 | 5 | 0.8 | 3.0 | SDF-first editor world reach | Basic | Multi-entity SDF primitive extraction, scene-product shader packet use, and picking consistency tests. | Make all editor SDF primitive entities render through one extracted scene packet before material, prefab, or terrain production work expands. |
| WR-019 | Field Visualizer product workflow | Product workflow | ready_next | L2 | After rendered-world V1 | 4 | 2 | 3 | 4 | 4 | 5 | 0.8 | 2.4 | Product debug workflow after viewport packet stability | Performance | Selected FieldPreviewProduct route, product kind/channel/slice/ramp controls, and unavailable-product diagnostics. | Build field visualization as viewport product selection, not as a parallel viewer. |
| WR-020 | Source-backed Asset Core | Core support | ready_next | L1 | Supporting now | 5 | 3 | 4 | 5 | 5 | 8 | 0.8 | 1.9 | Stable asset identity before material and prefab implementation | Basic | Project catalog descriptors, deterministic import jobs, diagnostics, and prior-valid artifact preservation. | Stabilize source descriptors for SDF graph, field product, material graph/material, UI definition, and prefab descriptors before broad external import work. |
| WR-021 | Material Lab and material preview products | Product workflow | ready_next | L3 | After rendered-world V1 and Field Visualizer | 4 | 2 | 3 | 4 | 4 | 8 | 0.5 | 0.9 | Material authoring after render/product handoff stabilizes | Performance | Source-backed MaterialGraphDocument, lowering/ratification, preview product, diagnostics, and render handoff. | Promote Material Lab now, but implement it after multi-entity viewport and field visualization stabilize. |
...
| WR-024 | Editor Shell Polish | Guardrail | ready_next | L1 | After Interaction V2 contract spine | 4 | 1 | 4 | 3 | 4 | 3 | 0.8 | 4.0 | Immediate viewport usability and menu clarity | Basic | Retained-UI slice evidence after the relevant Interaction V2 contracts exist for popup stack, scroll ownership, menu sizing, focus return, chrome slots, status overflow, and viewport input arbitration. | Treat editor shell polish as a retained-UI implementation slice under the broader Interaction V2 contract layer, not as a pile of isolated cosmetic fixes. |
| WR-025 | UI Runtime V2 and interaction formation | Architecture guardrail | current_candidate | L1 | Accepted architecture gate | 5 | 2 | 4 | 5 | 4 | 3 | 0.8 | 4.8 | Prevent repeated editor UI contract regressions | Basic | Accepted ADR 0009, active Interaction V2 design, roadmap row, subordinate polish-design link, and explicit migration spine from definition vocabulary through validation, formed model, retained adapter, runtime enforcement, and editor/app guards. | Accepted ADR 0009 inserts an execution-neutral interaction formation layer before retained UI products while keeping retained UI as the first execution target and renderer output as derived product data. |
