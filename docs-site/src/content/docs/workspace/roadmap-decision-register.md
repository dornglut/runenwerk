...
| WR-180 | UI Composition Cutover Governance And Visual Direction Gate | UI architecture | current_candidate | not_applicable | L4 | Accepted core/adaptive designs, ADR 0013, production track, and selected visual direction before implementation | 5 | 2 | 4 | 5 | 5 | 5 | 0.8 | 3.0 | N/A | Must-be | User approved the implementation-ready clean-cutover plan on 2026-06-19; accepted core/adaptive designs, ADR 0013, applied roadmap sequence, active production track, and WR-180 implementation contract are present. Visual selection remains the checkpoint stop gate. | User approved the implementation-ready clean-cutover plan on 2026-06-19; accepted core/adaptive designs, ADR 0013, applied roadmap sequence, active production track, and WR-180 implementation contract are present. Visual selection remains the checkpoint stop gate. |
| WR-181 | UI Composition Core Contracts And Invariants | UI architecture | ready_next | not_applicable | L4 | WR-180 visual direction selected and checkpoint 1 closed | 5 | 2 | 5 | 5 | 5 | 8 | 0.8 | 2.0 | N/A | Must-be | Runtime-proven definition, state, transaction, diagnostic, liveness, promotion, fixture, invariant, and structural-history contracts. | Create the core crate without editing runtime chrome, editor docking, Draw projection, ui_surface, or legacy workspace mutation paths. |
