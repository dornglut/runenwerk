...
| WR-172 | Architecture Behavior Truth And Extension Readiness Closure | Product planning | current_candidate | not_applicable | L4 | Current implementation candidate | 5 | 2 | 4 | 5 | 5 | 5 | 0.8 | 3.0 | N/A | Basic | Close PM-014 only after every semantic verifier is bound to executable behavior probes and future product-feature obligations are explicitly out-of-scope, deferred, or moved to future tracks. | Active closure gate superseding the current PM-013 completion claim. |
