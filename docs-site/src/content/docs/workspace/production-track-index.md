...
| ID | Milestone | Kind | State | Roadmap links | Outcome |
|---|---|---|---|---|---|
| PM-RENDER-GPU-001 | GPU Evidence And Procedural Visuals Doctrine | design | active | WR-082 | The active design and production track identify ownership, sequence, gates, non-goals, open decisions, and runtime_proven target evidence. |
...
| ID | Milestone | Kind | State | Roadmap links | Outcome |
|---|---|---|---|---|---|
| PM-RENDER-SCALE-001 | Scale Residency And Visibility Doctrine | design | active | N/A | Active design records unbounded world/product space as finite renderer working sets with explicit evidence requirements. |
| PM-RENDER-SCALE-002 | Working Set Registry And Residency Budgets | implementation | designing | WR-061 | Renderer inspection can explain resident GPU working sets, budget pressure, eviction or downgrade needs, and product-lineage keys. |
| PM-RENDER-SCALE-003 | GPU Driven Culling LOD And Indirect Submission | implementation | designing | WR-062 | Large addressable populations produce bounded draw or dispatch work with visible diagnostics for culled, visible, and submitted counts. |
| PM-RENDER-SCALE-004 | Scale Evidence And Production Readiness | hardening | designing | WR-063 | Runtime evidence can support millions-scale renderer claims without hiding culled, degraded, unsupported, or over-budget states. |

### PT-RENDER-SDF - Sparse SDF World Rendering And Raymarch Acceleration Platform

| ID | Milestone | Kind | State | Roadmap links | Outcome |
|---|---|---|---|---|---|
| PM-RENDER-SDF-001 | Sparse SDF Rendering Doctrine | design | active | N/A | Active design identifies renderer-owned SDF residency and acceleration separately from SDF product truth. |
| PM-RENDER-SDF-002 | SDF Brick Page And Clipmap Residency | implementation | designing | WR-064 | Renderer can inspect SDF resident pages, brick atlases, generation keys, cache pressure, and invalidation state. |
| PM-RENDER-SDF-003 | Raymarch Acceleration And Candidate Lists | implementation | designing | WR-065 | SDF raymarch flows avoid scanning all SDF sources per ray step and report unsafe-overstep or candidate explosion risks. |
| PM-RENDER-SDF-004 | SDF World Runtime Evidence | hardening | designing | WR-066 | SDF world rendering can claim runtime_proven with visible near/mid/far/summary behavior and diagnostic evidence. |

### PT-RENDER-MESH-MATERIAL - Mesh Material Lighting Shader And Asset Handoff Platform

| ID | Milestone | Kind | State | Roadmap links | Outcome |
|---|---|---|---|---|---|
| PM-RENDER-MESH-MATERIAL-001 | Mesh Material Lighting Handoff Doctrine | design | active | N/A | Active design records renderer responsibilities and asset/material/domain-owned truth boundaries. |
| PM-RENDER-MESH-MATERIAL-002 | Mesh Material Shader Asset Handoff | implementation | designing | WR-067 | Mesh/material previews and scene material paths produce visible pixels through prepared renderer contracts. |
