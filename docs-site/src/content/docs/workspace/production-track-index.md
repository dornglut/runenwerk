...
| PM-RENDER-POP-HARDEN-005 | Procedural Camera And View Projection | hardening | ready_next | WR-101 | Procedural examples can fill the target without letterbox or non-uniform stretch while keeping producer-owned camera intent separate from prepared view packets. |
