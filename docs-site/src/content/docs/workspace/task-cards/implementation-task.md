...
For architecture-sensitive, reusable, platform, public API, production-track, workflow, or domain-boundary work, also confirm the planning record points to complete investigation gate evidence and complete design gate evidence:
