...
| WR-019 | Field Visualizer product workflow | P1 | V4 | B2 | 2.4 | Plan immediately after rendered-world V1 stabilizes the packet/product handoff; this is the first FR-2 product-producer follow-up in the fully featured renderer roadmap. | Rendered-world V1 must first prove the viewport packet/product handoff and product target selection path. |
