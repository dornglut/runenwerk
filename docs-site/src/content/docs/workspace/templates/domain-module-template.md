---
title: Domain Module Template
description: Template for engine-agnostic domain module documentation.
status: active
owner: workspace
layer: workspace
canonical: true
...
Replace bracketed placeholders before copying this structure into an owning domain subtree.

# [Module Name] Module

## Purpose
- What this module represents in the domain layer
- Why it exists
- Problems it solves
