...
| WR-068 | Renderer Lighting Pipeline Cache And Last Good Fallback | Discovery | blocked_deferred | not_applicable | L4 | Policy deferred pending intake approval | 2 | 5 | 0.2 | Intake proposal only; do not implement until applied and promoted by roadmap review. | New idea has not passed roadmap intake, architecture governance, and dependency review. |
| WR-069 | Renderer Mesh Material Production Evidence | Discovery | blocked_deferred | not_applicable | L4 | Policy deferred pending intake approval | 2 | 5 | 0.2 | Intake proposal only; do not implement until applied and promoted by roadmap review. | New idea has not passed roadmap intake, architecture governance, and dependency review. |
| WR-070 | Renderer Temporal Inputs History And Dynamic Resolution | Discovery | blocked_deferred | not_applicable | L4 | Policy deferred pending intake approval | 2 | 5 | 0.2 | Intake proposal only; do not implement until applied and promoted by roadmap review. | New idea has not passed roadmap intake, architecture governance, and dependency review. |
| WR-071 | Renderer Upscaling Adapters And Ray Reconstruction Inputs | Discovery | blocked_deferred | not_applicable | L4 | Policy deferred pending intake approval | 2 | 5 | 0.2 | Intake proposal only; do not implement until applied and promoted by roadmap review. | New idea has not passed roadmap intake, architecture governance, and dependency review. |
| WR-072 | Renderer Temporal Production Evidence | Discovery | blocked_deferred | not_applicable | L4 | Policy deferred pending intake approval | 2 | 5 | 0.2 | Intake proposal only; do not implement until applied and promoted by roadmap review. | New idea has not passed roadmap intake, architecture governance, and dependency review. |
| WR-073 | Renderer Ray Query Capability And Acceleration Resources | Discovery | blocked_deferred | not_applicable | L4 | Policy deferred pending intake approval | 2 | 5 | 0.2 | Intake proposal only; do not implement until applied and promoted by roadmap review. | New idea has not passed roadmap intake, architecture governance, and dependency review. |
| WR-074 | Renderer Hybrid Ray SDF Raster Runtime Proof | Discovery | blocked_deferred | not_applicable | L4 | Policy deferred pending intake approval | 2 | 5 | 0.2 | Intake proposal only; do not implement until applied and promoted by roadmap review. | New idea has not passed roadmap intake, architecture governance, and dependency review. |
| WR-075 | Renderer Ray Query Production Evidence | Discovery | blocked_deferred | not_applicable | L4 | Policy deferred pending intake approval | 2 | 5 | 0.2 | Intake proposal only; do not implement until applied and promoted by roadmap review. | New idea has not passed roadmap intake, architecture governance, and dependency review. |
| WR-076 | Renderer Product Visuals Particles VFX Trails And Decals | Discovery | blocked_deferred | not_applicable | L4 | Policy deferred pending intake approval | 2 | 5 | 0.2 | Intake proposal only; do not implement until applied and promoted by roadmap review. | New idea has not passed roadmap intake, architecture governance, and dependency review. |
| WR-077 | Renderer Product Visuals Vegetation Water Atmosphere Weather And Field Visuals | Discovery | blocked_deferred | not_applicable | L4 | Policy deferred pending intake approval | 2 | 5 | 0.2 | Intake proposal only; do not implement until applied and promoted by roadmap review. | New idea has not passed roadmap intake, architecture governance, and dependency review. |
| WR-078 | Renderer Product Visuals Animation Deformation And Evidence | Discovery | blocked_deferred | not_applicable | L4 | Policy deferred pending intake approval | 2 | 5 | 0.2 | Intake proposal only; do not implement until applied and promoted by roadmap review. | New idea has not passed roadmap intake, architecture governance, and dependency review. |
