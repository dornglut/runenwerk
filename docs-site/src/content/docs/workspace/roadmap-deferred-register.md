...
| WR-148 | Governance And Truth Claim Activation | Product planning | blocked_deferred | not_applicable | L4 | Design-only Track Expansion gate | 4 | 4 | 1.0 | Auto-safe Track Expansion created this deferred WR from PT-UI-PROGRAM-ARCHITECTURE manifest data only; it authorizes planning metadata, not product code. | Track Expansion linked WR authority mechanically; the milestone work itself has not started. |
