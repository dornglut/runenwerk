...
| WR-137 | Control Package Proof Design | Product planning | blocked_deferred | not_applicable | L4 | Design-only Track Expansion gate | 4 | 4 | 1.0 | Auto-safe Track Expansion created this deferred WR from PT-UI-PROGRAM manifest data only; it authorizes planning metadata, not design authoring or implementation. | Track Expansion linked WR authority mechanically; the milestone work itself has not started. |
