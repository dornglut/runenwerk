...
|---|---|---|---|---|---|---|---|---|
| PT-SDF-OW | PM-SDF-OW-001 Production product spine | implementation | active | N/A | WR-019, WR-026, WR-021 | design:docs-site/src/content/docs/design/accepted/sdf-first-production-capability-map.md requires accepted<br>design:docs-site/src/content/docs/design/active/field-visualizer-product-workflow-design.md requires active<br>design:docs-site/src/content/docs/design/active/editor-asset-pipeline-and-content-workflow-design.md requires active<br>design:docs-site/src/content/docs/design/active/material-lab-and-material-preview-design.md requires active | N/A | Product debug, asset catalog adapters, material preview products, and renderer handoff are validated through their WR closeouts.<br>No product workflow adds a parallel viewer, asset truth store, or renderer-owned semantic source. |
