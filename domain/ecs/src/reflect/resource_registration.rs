...
pub type ResourceValueRefAccessor =
	for<'a> fn(&'a World) -> Option<ReflectValueRef<'a>>;
pub type ResourceValueMutAccessor =
	for<'a> fn(&'a mut World) -> Option<ReflectValueMut<'a>>;
	...
	T: Reflect + Resource,
{
	...
	ReflectedResourceRegistration::new(
		T::type_info(),
		value_ref_impl::<T>,
		value_mut_impl::<T>,
	)
