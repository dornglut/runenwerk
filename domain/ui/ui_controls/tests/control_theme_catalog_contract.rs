use ui_controls::{
    ...
    ControlThemeTokenRole, ControlVisualState, ControlVisualStateRequirement, LABEL_CONTROL_KIND_ID,
...
fn control_theme_summary_attaches_to_catalog_inspection_read_only() {
    ...
    assert_eq!(
        inspection.fact(ControlInspectionSection::Theme, "has_runtime_style_behavior"),
        Some("false")
    );
}
