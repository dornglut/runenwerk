...
use super::{diagnostic_badges, ControlCatalogEntryDescriptor, ControlDiagnosticBadge, ControlStoryProofBadge};

#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct ControlInspectionDescriptor { pub package_id: String, pub control_kind_id: String, pub display_name: String, pub facts: Vec<ControlInspectionFact>, pub diagnostic_badges: Vec<ControlDiagnosticBadge>, #[serde(default)] pub story_proof_badge: Option<ControlStoryProofBadge> }
...
pub enum ControlInspectionSection { Identity, Metadata, Compatibility, Schemas, Kernels, Routes, Fixtures, Stories, StoryProof, Input, Interaction, Layering, State, Theme, Accessibility, Diagnostics, MountEligibility }
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
