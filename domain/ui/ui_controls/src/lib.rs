...
pub fn runenwerk_control_package() -> ControlPackageDescriptor { BaseControlsPlugin::new().package() }
...
mod tests {
    ...
    #[test]
    fn control_package_rejects_duplicate_interaction_descriptor() { let mut package = runenwerk_control_package(); package.interaction_descriptors.push(package.interaction_descriptors[0].clone()); assert_has_reason(package, ControlPackageValidationReason::DuplicateInteractionDescriptor); }
    #[test]
    fn control_package_rejects_duplicate_generic_text_descriptor() { let mut package = runenwerk_control_package(); package.generic_text_descriptors.push(package.generic_text_descriptors[0].clone()); assert_has_reason(package, ControlPackageValidationReason::DuplicateGenericTextDescriptor); }
    #[test]
