...
pub enum EditorDefinitionSurfaceAction {
    ...
    ExportSelected,
    CreateWorkbenchCompositionPackage,
    BuildApplyReview,
    RejectApplyReview,
    ApplySelected,
    ActivateSelectedWorkbenchComposition,
    RollbackSelected,
    ReloadLastApplied,
    UndoOperation,
    RedoOperation,
    ...
    SetWorkbenchInstalledSuites { installed_suites: String },
    SetWorkbenchProfileRefs { profile_refs: String },
    SetWorkbenchDefaultProfileRef { profile_ref: String },
