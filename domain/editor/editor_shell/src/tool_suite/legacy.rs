...
//! enum callers, authored legacy-key adapters, and tests that prove those
//! retained boundary paths still work. Unsupported V1-V5 workspace persistence
//! is quarantined to predecessor tests and is not a production migration API.
//!
