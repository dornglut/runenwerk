...
pub use surfaces::{
    ...
    InspectorSessionMutation, InspectorSurfaceAction, MaterialDiagnosticRowViewModel,
    MaterialDiagnosticSeverity, MaterialGraphCanvasViewModel, MaterialGraphEdgeViewModel,
    MaterialGraphEditorViewModel, MaterialGraphGroupViewModel, MaterialGraphNodeViewModel,
    MaterialGraphPortViewModel, MaterialGraphPropertyViewModel,
    ...
    MaterialPreviewPublicationStatusKind, MaterialPreviewStatusKind, MaterialPreviewStatusViewModel,
    ...
    MaterialPreviewViewModel, MaterialShortcutAction, MaterialSurfaceAction,
...
pub use tool_suite::{
    EditorToolSuite, LegacyToolSurfaceResolution, LegacyToolSurfaceStableKeyCandidate,
    ...
    SAVEABLE_TOOL_SURFACE_STABLE_KEY_CANDIDATES, ToolSuiteId, ToolSuiteIdentityError,
    ToolSuiteRegistry, ToolSuiteRegistryError, ToolSurfaceDefinition, ToolSurfacePersistence,
    ToolSurfaceRegistry, ToolSurfaceResolution, ToolSurfaceRole, ToolSurfaceRoute,
    ToolSurfaceStableKey, resolve_legacy_tool_surface_kind,
...
pub use workspace::{
    ...
    PersistedToolSurfaceStateV2, PersistedToolSurfaceStateV3, PersistedToolSurfaceStateV5,
    ...
    tool_surface_session_retention_class, viewport_embed_slot_for,
};
