...
pub use workspace::{
    ...
    PersistedWorkspaceStateV1, ProjectedPanelSlot, SplitHostState,
    ...
    WorkspaceIdentityAllocator, WorkspaceIdentitySeed, WorkspaceMutation, WorkspaceProjectionArtifact,
    WorkspaceSplitAxis, WorkspaceState, WorkspaceStateError, project_fixed_layout,
    project_workspace_for_shell, reduce_workspace,
};
