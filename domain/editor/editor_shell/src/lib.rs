...
pub use workspace::{
    ...
    editor_surface_definitions, form_workspace_state_from_definition, mounted_surface_instance,
    mounted_surface_instances, panel_kind_definition_key, panel_kind_for_tool_surface_kind,
    project_fixed_layout, project_workspace_for_shell, projected_host_tab_stacks, reduce_workspace,
