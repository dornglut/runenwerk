...
pub use surfaces::{
    ...
    EditorLabCatalogItemDetails, EditorLabCatalogItemViewModel, EditorLabConsoleLineViewModel,
    EditorLabConsoleViewModel, EditorLabDefinitionHierarchyViewModel,
