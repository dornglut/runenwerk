...
pub use tile::{
    ...
    drawing_ink_tile_invalidation_for_strokes, drawing_ink_tile_product_cache_identity,
    drawing_ink_tile_product_descriptor, drawing_ink_tile_query_snapshot_for_descriptor,
    drawing_quality_scale_band, drawing_tile_determinism_key, form_drawing_ink_preview_tiles,
