...
impl SceneRegistry {
    pub fn load() -> Self {
        ...
        let mut descriptors = vec![
            ...
            default_descriptor(SceneId::InventoryUi),
        ];
...
fn default_descriptor(id: SceneId) -> SceneDescriptor {
    SceneDescriptor {
        ...
        ui_template: match id {
            SceneId::ConsoleUi => Some("game/assets/ui/console.ron".to_string()),
            SceneId::HudUi => Some("game/assets/ui/hud.ron".to_string()),
            SceneId::InventoryUi => Some("game/assets/ui/inventory.ron".to_string()),
...
mod tests {
    ...
    fn scene_registry_contains_all_core_scenes() {
        ...
        assert_eq!(
            registry.descriptor(SceneId::InventoryUi).id,
            SceneId::InventoryUi
        );
    }
}
