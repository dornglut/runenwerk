...
use crate::app::App;
use crate::runtime::{
    CoreSet, FixedUpdate, PreUpdate, Startup, SystemConfigExt, SystemMobilityExt, Update,
};

pub(crate) fn install_scene_runtime_systems(app: &mut App) {
    app.add_systems(Startup, scene_setup_system.on_invoker_thread());
    app.add_systems(
        PreUpdate,
