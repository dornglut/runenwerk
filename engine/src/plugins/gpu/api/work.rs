...
impl GpuRenderOperation {
    pub fn new(
        ...
        depth_stencil_attachment: Option<GpuRenderDepthStencilAttachment>,
        draws: impl IntoIterator<Item = GpuDrawIntent>,
    ...
    pub fn draws(&self) -> &[GpuDrawIntent] {
        &self.draws
    }
...
impl GpuWorkOperation {
    ...
    pub fn derived_requirements(
        ...
        let primary = match self {
            ...
            Self::Copy(_) | Self::Clear(_) => GpuCapabilityFeature::Copy,
...
mod tests {
    ...
    #[test]
    fn operation_kind_and_capabilities_are_derived_once() {
        let operation = GpuWorkOperation::Compute(GpuComputeOperation::new(
