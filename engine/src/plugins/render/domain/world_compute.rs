...
impl WorldComputeRenderer {
    ...
    fn rebuild_pass(
        ...
        let compute_shader_basic = device.create_shader_module(ShaderModuleDescriptor {
            label: Some("engine_world_compute_shader_basic"),
        ...
        let models_buffer = device.create_buffer(&BufferDescriptor {
            label: Some("engine_world_models_buffer"),
        ...
        let world_texture = device.create_texture(&TextureDescriptor {
            label: Some("engine_world_compute_texture"),
            size: Extent3d {
                width: width.max(1),
                height: height.max(1),
        ...
        let world_sampler = device.create_sampler(&SamplerDescriptor {
            label: Some("engine_world_sampler"),
        ...
        let compute_bind_group_layout =
            device.create_bind_group_layout(&BindGroupLayoutDescriptor {
                label: Some("engine_world_compute_bind_group_layout"),
                entries: &[
        ...
        let compute_bind_group = device.create_bind_group(&BindGroupDescriptor {
            label: Some("engine_world_compute_bind_group"),
        ...
        let compute_pipeline_high_contrast =
            device.create_compute_pipeline(&ComputePipelineDescriptor {
                label: Some("engine_world_compute_pipeline_high_contrast"),
                layout: Some(&compute_pipeline_layout),
        ...
        let compose_bind_group_layout =
            device.create_bind_group_layout(&BindGroupLayoutDescriptor {
                label: Some("engine_world_compose_bind_group_layout"),
                entries: &[
                    BindGroupLayoutEntry {
                        binding: 0,
        ...
        let compose_bind_group = device.create_bind_group(&BindGroupDescriptor {
            label: Some("engine_world_compose_bind_group"),
    ...
    pub fn encode_compute_pass(&self, encoder: &mut CommandEncoder, pipeline: PipelineKey) {
...

        {
            let mut compute = encoder.begin_compute_pass(&ComputePassDescriptor {
                label: Some("engine_world_compute_pass"),
    ...
    pub fn encode_compose_pass(
...

        {
            let mut compose = encoder.begin_render_pass(&RenderPassDescriptor {
                label: Some("engine_world_compose_pass"),
