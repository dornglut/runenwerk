...
pub fn build_transient_windows(graph: &RenderFlowGraph) -> Vec<TransientResourceWindow> {
    let mut pass_usages = BTreeMap::<String, (usize, usize)>::new();
        ...
        .filter_map(|id| {
            pass_usages
                ...
                .map(|(first, last)| TransientResourceWindow {
                    resource_id: RenderResourceId::new(id),
...
fn pass_resource_ids(pass: &crate::plugins::render::RenderPassNode) -> impl Iterator<Item = &str> {
    pass.reads
        .iter()
