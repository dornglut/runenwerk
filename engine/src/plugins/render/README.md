...
Longer-term render architecture notes remain in [ecs-first-proposal.md](/Users/joshua/Projekte/multiplayer_workspace/grotto-quest/engine/src/plugins/render/ecs-first-proposal.md), but this README describes the active path rather than the migration history.
