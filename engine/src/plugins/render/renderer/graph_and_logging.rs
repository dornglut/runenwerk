...
impl Renderer {
    ...
    pub(super) fn builtin_pass_executor(
    ...
    pub(super) fn log_frame_graph_diagnostics(
        &mut self,
        world_scene: &str,
        overlay_scene: &str,
    ...
    pub(super) fn log_missing_executors_once(&mut self, missing_executors: &[(String, String)]) {
    ...
    pub(super) fn log_execution_order_error_once(&mut self, err: &anyhow::Error) {
    ...
    pub(super) fn resolved_registered_descriptors(
        &self,
    ...
    pub(super) fn build_frame_graph_from_descriptors(
        &self,
