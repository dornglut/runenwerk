...
fn build_boids_flow() -> RenderFlow {
    RenderFlow::new("bench.boids")
        ...
        .uniform_from_state::<BenchState, ComputeParams>(BenchState::compute_params)
...
fn build_compositor_flow() -> RenderFlow {
    RenderFlow::new("bench.compositor")
        ...
        .bind_ping_pong_storage("post.history")
        .uniform_from_state_with_surface::<BenchState, ComposeParams>(BenchState::compose_params)
        .write_surface_color()
...
fn build_sdf_like_flow() -> RenderFlow {
    let (flow, field) = RenderFlow::new("bench.sdf").storage_array::<BoidInstance>("sdf.field", 2048);
