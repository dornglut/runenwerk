...
fn viewport_interaction_drag_requires_active_drag_session() {
    ...
    let error = app
        .dispatch_viewport_interaction_command(ViewportInteractionCommand::PointerDragAxis {
            amount: 1.0,
        })
...
#[test]
fn viewport_input_pointer_down_selects_entity() {
    let mut app = RunenwerkEditorApp::new();
...
#[test]
fn viewport_input_gizmo_drag_commits_translation() {
    let mut app = RunenwerkEditorApp::new();
    let transform_type = ComponentTypeId(500);
    ...
    .expect("gizmo down should succeed");
...
#[test]
fn viewport_input_cancel_clears_drag_without_commit() {
    let mut app = RunenwerkEditorApp::new();
    let transform_type = ComponentTypeId(500);
...
#[test]
fn viewport_interaction_exposes_drag_state_and_tool_preview() {
    let mut app = RunenwerkEditorApp::new();
    let transform_type = ComponentTypeId(500);
    ...
    let tool_state = app.viewport_tool_state();
...
#[test]
fn viewport_interaction_pointer_up_commits_and_clears_drag_state() {
    let mut app = RunenwerkEditorApp::new();
    let transform_type = ComponentTypeId(500);
...
#[test]
fn viewport_interaction_cancel_clears_drag_state_without_commit() {
    let mut app = RunenwerkEditorApp::new();
    let transform_type = ComponentTypeId(500);
    ...
    assert_eq!(app.viewport_interaction_state().active_entity(), None);
    assert_eq!(app.viewport_interaction_state().active_axis(), None);
    assert_eq!(app.viewport_tool_state().active_preview, None);
...
#[test]
fn viewport_frame_state_reflects_selection_and_drag_state() {
    let mut app = RunenwerkEditorApp::new();
    let transform_type = ComponentTypeId(500);
    ...
    assert_eq!(app.viewport_interaction_state().active_axis(), None);
    assert_eq!(app.viewport_tool_state().active_preview, None);
    assert_eq!(app.viewport_tool_state().active_translate_axis, None);
    ...
    assert_eq!(
        app.viewport_tool_state().active_translate_axis,
        Some(TranslateAxis::X)
    );
...
#[test]
fn viewport_frame_state_clears_after_cancel() {
    let mut app = RunenwerkEditorApp::new();
    let transform_type = ComponentTypeId(500);
