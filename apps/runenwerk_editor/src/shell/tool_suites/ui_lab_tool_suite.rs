...
pub fn ui_lab_tool_suite() -> EditorToolSuite {
    let suite_id = ToolSuiteId::new("runenwerk.ui_lab")
        .expect("compiled-in UI Lab suite id should be valid");
    ...
    EditorToolSuite::new(
        ...
        "UI Lab",
        vec![ProviderFamilyDefinition::new(provider_family.clone(), "UI Lab")],
