...
use editor_shell::{
    ...
    ToolSurfaceStableKey, UI_DESIGNER_WORKBENCH_TARGET_PROFILE, UiDesignerWorkbenchPaneKind,
    UiDesignerWorkbenchPaneViewModel, UiDesignerWorkbenchReadinessStatus,
    UiDesignerWorkbenchReadinessViewModel, UiDesignerWorkbenchViewModel, UiNode,
    ...
    ViewportSurfaceAction, ViewportViewModel, WidgetId, WorkspaceProfileRegistry,
    build_console_panel, build_editor_lab_surface, build_entity_table_panel, build_inspector_panel,
    ...
    surface_widget_id, tool_surface_capabilities_from_registry_or_legacy,
