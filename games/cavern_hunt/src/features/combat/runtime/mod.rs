...
use movement_fire::{
    ProjectileStepMode,
    fire_player_weapon_with_control,
    move_player_with_control,
    resolve_local_player_entity,
};
use plugin_aim::update_local_aim;
use projectiles::{camera_relative_movement, movement_footprint_radius, normalized_vector, step_projectiles};
