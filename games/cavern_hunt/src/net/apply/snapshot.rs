...
use super::super::legacy::{CavernNetSyncState, ClientReplicationStateV2};
use super::player::{
...
pub(super) struct CavernGeometryEditsEventV2 {
    tick: SimulationTick,
    from_index: usize,
    to_index: usize,
...
pub(super) fn apply_authoritative_geometry_edits(
    world: &mut World,
    event: CavernGeometryEditsEventV2,
) -> Result<()> {
