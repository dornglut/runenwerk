...
Roadmap reference (workspace): [`/docs/roadmaps/ROADMAP.md`](../../../../docs/roadmaps/ROADMAP.md)
Companion full-switch plan: [`/foundation/ecs/docs/roadmaps/phase6-archetype-full-switch-plan.md`](./phase6-archetype-full-switch-plan.md)
Closeout roadmap: [`/foundation/ecs/docs/roadmaps/phase6-closeout-roadmap.md`](./phase6-closeout-roadmap.md)
...
- Phase 6 docs and closeout reports remain aligned with `/docs/roadmaps/ROADMAP.md` and `/foundation/ecs/docs/roadmaps/phase6-closeout-roadmap.md`.
